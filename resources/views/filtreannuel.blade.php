...
<style type="text/css">
    body {
            ...
            background-image: url('../storage/email.gif'); /* Assurez-vous que le chemin de votre image est correct */
    ...
    .button {
              ...
              margin-left: 110px; /* Marge à gauche */
...
<x-app-layout>
    ...
    <br>
    <button class="button"><a>2020</a></button>
    <br>
    <button class="button"><a>2021</a></button>
    <br>
    <button class="button"><a>2022</a></button>
    <br>
    <button class="button"><a>2023</a></button>
    <br>
    <button class="button"><a>2024</a></button>
    <br>
    <button class="button"><a>2025</a></button>
...
<table class="container">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><center><button style="width:100%" class="form-control" class="ml-4"><a href="">Modifier</a></button></center></td>

            <td><center><button style="width:100%" class="form-control" class="ml-4"><a href="">Supprimer</a></button></center></td>
        </tr>
        @endforeach
    </tbody>
</table>
